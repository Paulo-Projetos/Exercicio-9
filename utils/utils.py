# estrutura de tratamento de erro da massa de dados, a ser usada no calculo da rea do triangulo.
import csv  # biblioteca para aquivos de planilha csv
...
def ler_csv(arquivo_csv):
    ...
    try:                                                # tentar / tratamento de erro
        with open(arquivo_csv, newline='') as massa:    # tenta abrir arquivo csv e newline indica o final de linha
            ...
            next(tabela)                                # Pula linha de cabeçalho (b, h, resultado esperado)
